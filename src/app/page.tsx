      ...
      <section className="pt-16 px-6 max-w-8xl mx-auto">
        ...
        <div className="relative mt-24 mb-16 w-full">
              ...
              <div className="md:w-2/3">
                <div className="mb-4">
                  ...
                  <p className="text-blue-100">
                    Computer not turning on after power outage. Need urgent assistance as this is affecting my work.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-blue-100 text-sm">Last updated: 2 hours ago</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="hidden md:block absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/4 bg-white p-5 rounded-xl shadow-lg w-64 z-20">
            ...
            <p className="text-gray-600 text-sm">Submit requests in just a few clicks with our intuitive form</p>
          </div>
          ...
          <div className="hidden md:block absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-1/4 bg-white p-5 rounded-xl shadow-lg w-64 z-20">
            ...
            <p className="text-gray-600 text-sm">Track the status of your requests with real-time notifications</p>
          </div>
          ...
          <div className="hidden md:block absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/4 bg-white p-5 rounded-xl shadow-lg w-64 z-20">
            ...
            <p className="text-gray-600 text-sm">Work together with service providers to resolve your issues</p>
          </div>
        </div>
      </section>
            ...
            <div className="flex">
              ...
              <div className="ml-6 bg-white p-6 rounded-xl shadow-md flex-1">
                ...
                <p className="text-gray-600 leading-relaxed">
                  You can begin by submitting a service request using the system. Whether you&lsquo;re reporting an issue,
                  requesting maintenance, or suggesting an improvement, simply fill out the request form. Once
          ...
          <div className="relative">
            <div className="flex">
              ...
              <div className="ml-6 bg-white p-6 rounded-xl shadow-md flex-1">
                ...
                <p className="text-gray-600 leading-relaxed">
                  After the project is completed, you&apos;ll be invited to provide feedback through a short survey. Your
                  input helps us evaluate the quality of service and improve future processes, ensuring your next
